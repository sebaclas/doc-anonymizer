...
Se ha propuesto permitir que la revisión de entidades detectadas ocurra asincrónicamente con la ayuda de un documento `.xlsx` generado automáticamente. El flujo actual pide input por terminal `s/n/e` frenando el procesamiento general, lo cual es ineficiente en documentos masivos o en empresas segmentadas en áreas de cumplimiento y operación.
