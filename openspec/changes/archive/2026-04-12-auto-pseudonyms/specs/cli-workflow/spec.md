...
- **AND THEN** the interactive prompts SHALL suggest an automatically generated pseudonym as the default choice.
...
- **AND THEN** if Excel output is requested, new entities SHALL have suggested pseudonyms pre-filled.
